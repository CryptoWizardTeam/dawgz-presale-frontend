const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-nGN8Yw8W.js","assets/index-B-fQXv5e.js","assets/index-Bsn0gcxL.css"])))=>i.map(i=>d[i]);
import{i as C,b as S,M as r,C as h,O as v,aS as k,A as f,E,x as A,R as c,aT as b,U as _,m as x,S as O,aU as g,aV as N,d as w,c as L,aW as I}from"./index-B-fQXv5e.js";const T=C`
  :host {
...
`;var d=function(u,e,t,i){var o=arguments.length,s=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(u,e,t,i);else for(var a=u.length-1;a>=0;a--)(n=u[a])&&(s=(o<3?n(s):o>3?n(e,t,s):n(e,t))||s);return o>3&&s&&Object.defineProperty(e,t,s),s};const y="scroll-lock";let l=class extends S{constructor(){super(),this.unsubscribe=[],this.abortController=void 0,this.open=r.state.open,this.caipAddress=h.state.activeCaipAddress,this.caipNetwork=h.state.activeCaipNetwork,this.isSiweEnabled=v.state.isSiweEnabled,this.shake=r.state.shake,this.initializeTheming(),k.prefetch(),this.unsubscribe.push(r.subscribeKey("open",e=>e?this.onOpen():this.onClose()),r.subscribeKey("shake",e=>this.shake=e),f.subscribeKey("siweStatus",e=>this.onSiweStatusChange(e),"eip155"),h.subscribeKey("activeCaipNetwork",e=>this.onNewNetwork(e)),h.subscribeKey("activeCaipAddress",e=>this.onNewAddress(e)),v.subscribeKey("isSiweEnabled",e=>this.isSiweEnabled=e)),E.sendEvent({type:"track",event:"MODAL_LOADED"})}disconnectedCallback(){this.unsubscribe.forEach(e=>e()),this.onRemoveKeyboardListener()}render(){return this.open?A`
    ...
    `,document.head.appendChild(e)}onScrollUnlock(){const e=document.head.querySelector(`style[data-w3m="${y}"]`);e&&e.remove()}onAddKeyboardListener(){var t;this.abortController=new AbortController;const e=(t=this.shadowRoot)==null?void 0:t.querySelector("wui-card");e==null||e.focus(),window.addEventListener("keydown",i=>{if(i.key==="Escape")this.handleClose();else if(i.key==="Tab"){const{tagName:o}=i.target;o&&!o.includes("W3M-")&&!o.includes("WUI-")&&(e==null||e.focus())}},this.abortController)}onRemoveKeyboardListener(){var e;(e=this.abortController)==null||e.abort(),this.abortController=void 0}onSiweStatusChange(e){e==="success"&&r.close()}async onNewAddress(e){var n;const t=this.caipAddress,i=t?g.getPlainAddress(t):void 0,o=e?g.getPlainAddress(e):void 0,s=i===o;if(this.caipAddress=e,o&&!s&&this.isSiweEnabled)try{const{SIWEController:a}=await b(async()=>{const{SIWEController:p}=await import("./index-nGN8Yw8W.js");return{SIWEController:p}},__vite__mapDeps([0,1,2])),m=f.state.siweStatus==="success";!i&&o?this.onSiweNavigation():m&&i&&o&&i!==o&&(n=a.state._client)!=null&&n.options.signOutOnAccountChange&&(await a.signOut(),this.onSiweNavigation())}catch(a){throw this.caipAddress=t,a}o||r.close()}async onNewNetwork(e){var o,s,n,a;if(!this.caipAddress){this.caipNetwork=e,c.goBack();return}const t=(s=(o=this.caipNetwork)==null?void 0:o.caipNetworkId)==null?void 0:s.toString(),i=(n=e==null?void 0:e.caipNetworkId)==null?void 0:n.toString();if(t&&i&&t!==i)if(this.isSiweEnabled){const{SIWEController:m}=await b(async()=>{const{SIWEController:p}=await import("./index-nGN8Yw8W.js");return{SIWEController:p}},__vite__mapDeps([0,1,2]));(a=m.state._client)!=null&&a.options.signOutOnNetworkChange?(await m.signOut(),this.onSiweNavigation()):c.goBack()}else c.goBack();this.caipNetwork=e}onSiweNavigation(){const e=h.state.activeChain===N.CHAIN.EVM;!(f.state.siweStatus==="success")&&e?this.open?c.replace("ConnectingSiwe"):r.open({view:"ConnectingSiwe"}):c.goBack()}};l.styles=T;d([w()],l.prototype,"open",void 0);d([w()],l.prototype,"caipAddress",void 0);d([w()],l.prototype,"caipNetwork",void 0);d([w()],l.prototype,"isSiweEnabled",void 0);d([w()],l.prototype,"shake",void 0);l=d([L("w3m-modal")],l);export{l as W3mModal};
